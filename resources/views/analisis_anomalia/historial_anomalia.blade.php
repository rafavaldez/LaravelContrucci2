    ...
    >
      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          {% if 'user_role' in session and 'admin' in session['user_role'] %}
          <ul class="mt-6">
          ...
          <ul>
            <li class="relative px-6 py-3">
              ...
              <a
                ...
                class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                href="{{ url_for('admin_historialanomalias') }}"
              ...
              >
                ...
                <span class="ml-4">Historial de Analisis</span>
              </a>
            </li>
          </ul>
                  ...
                  <div class="p-6 flex justify-between">
                      <div class="flex items-center space-x-4">
                          <div class="flex-shrink-0">
                              <svg class="w-12 h-12 text-blue-500" fill="currentColor" viewBox="0 0 20 20"><path d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zM3 7h14V5a1 1 0 00-1-1H4a1 1 0 00-1 1v2zm1 8v-7h12v7a1 1 0 01-1 1H5a1 1 0 01-1-1z"></path></svg>
                          </div>
                          <div>
                              ...
                              <p class="mt-2 text-sm text-gray-600">
                                  Fecha de inserción: {{ doc.fecha_upload }}
                              </p>
                          </div>
                      </div>
                      <div class="flex flex-col space-y-2">
                        <form action="/admin/ResultadosAnalisis" method="post">
                            <input type="hidden" name="filename" value="{{ doc.data_json }}">
                            <input type="hidden" name="id_json" value="{{ doc._id }}">

                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                Ver Análisis
                            </button>
                        </form>
                        <form action="/admin/ResultadosInforme" method="post">
                            <input type="hidden" name="reporte" value="{{ doc.reporte }}">
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                Ver Informe
                            </button>
                        </form>

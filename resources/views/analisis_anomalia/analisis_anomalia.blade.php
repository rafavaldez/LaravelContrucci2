  ...
  <body>
    ...
    >
      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <div class="wrapper">
              <header>Carga Archivo</header>
              <form action="#" enctype="multipart/form-data">
                <input class="file-input" type="file" name="file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" hidden>
                <i class="fas fa-cloud-upload-alt"></i>
                <p>Explorar Archivo csv o excel</p>
              </form>
            ...
            <div class="results w-full overflow-hidden rounded-lg shadow-xs w-full overflow-x-auto dataTables_wrapper no-footer" id="myTable_wrapper">
              ...
              <div class="w-full overflow-hidden rounded-lg shadow-xs">
                <div class="w-full overflow-x-auto">
                  <table id="data-table" class="w-full whitespace-no-wrap datatable">
                  </table>
                </div>
              </div>
            </div>
      ...
      infoFiltered: "(filtrados de _MAX_ registros en total)",
            ...
            <!-- Pantalla de carga modal (agrega estilos CSS según tus necesidades) -->
            

            <!-- Botón de procesar -->
            <div class="text-center mt-4">
              <button id="mostrar-loader" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                Procesar
              </button>
            </div>
